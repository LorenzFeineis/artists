...
class Net(nn.module):
    def __init__(self,size=(256,256),norm_size=5, num_classes = 10):
        ...
        self.conv1 = nn.Conv2d(in_channels=3,out_channels=12, kernel_size=(7,7),stride=4, padding=0)
        self.norm1 = nn.LocalResponseNorm(k)
        self.relu1 = nn.ReLU()
        self.pool1 = nn.MaxPool2d(kernel_size = (7,7))
        ...
        self.conv2 = nn.Conv2d(in_channels=12, out_channels=12, kernel_size=(3,3), stride=1, padding=0)
        self.norm2 = nn.LocalResponseNorm(k)
        self.relu2 = nn.RelU()

        # Input x2 (12, width/4, height/4)
        self.conv3 = nn.Conv2d(in_channels=12, out_channels=24, kernel_size=(3,3), stride=2, padding=0)
        self.relu3 = nn.RelU()
        ...
        self.conv4 = nn.Conv2d(in_channels=24, out_channels=24, kernel_size=(3,3), stride=1, padding=0)
        self.relu4 = nn.RelU()

        # Input x4 (24, width/8, height/8)
        self.conv5 = nn.Conv2d(in_channels=24, out_channels=48, kernel_size=(3,3), stride=2, padding=0)
        self.relu5 = nn.RelU()
        ...
        self.conv6 = nn.Conv2d(in_channels=48, out_channels=48, kernel_size=(3,3), stride=1, padding=0)
        self.relu6 = nn.RelU()

        # Input x6 (48, width/16, height/16)
        self.conv7 = nn.Conv2d(in_channels=48, out_channels=96, kernel_size=(3,3), stride=2, padding=0)
        self.relu7 = nn.RelU()
        ...
        self.conv8 = nn.Conv2d(in_channels=96, out_channels=192, kernel_size=(3,3), stride=1, padding=0)
        self.relu8 = nn.RelU()

        self.globalpool = nn.MaxPool2d(kernel_size=(3,3))

        # Output (192, width/32, height/32)
        # Input (-1, width/32, height/32)
        self.fcn1 = nn.Linear(in_features = 192*size[0]*size[1]/32**2,out_features = 200)
        self.relu9 = nn.ReLU()
    ...
    def forward(self,x):
        ...
        x6 = self.relu6(self.conv(x5+self.short2(x3)))
